...
Store Supabase and other API keys in `.env.local` and NEVER commit them. Provide `.env.example` updates when new variables are required. Review Next.js and Vercel settings after changing environment variables.
